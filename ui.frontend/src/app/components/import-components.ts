 ...
 */
MapTo('virtualstudymaster/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('virtualstudymaster/components/separator')(SeparatorV1Component);

MapTo('virtualstudymaster/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('virtualstudymaster/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('virtualstudymaster/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('virtualstudymaster/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('virtualstudymaster/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('virtualstudymaster/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('virtualstudymaster/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('virtualstudymaster/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('virtualstudymaster/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('virtualstudymaster/components/accordion')(AccordionV1Component);
MapTo('virtualstudymaster/components/tabs')(TabsV1Component);
...
LazyMapTo('virtualstudymaster/components/teaser')(TeaserV1Component);
...
LazyMapTo('virtualstudymaster/components/carousel')(CarouselV1Component);
...
LazyMapTo('virtualstudymaster/components/text')(LazyTextModule, TextEditConfig);